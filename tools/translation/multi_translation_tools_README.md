...
本项目提供了多个翻译管理脚本，用于收集、翻译和管理 OpenPilot 项目的多语言翻译。

## 工具概览

### 1. multi_translator.py (多翻译器版本) ⭐ 推荐
最新的多翻译器管理工具，支持：
- 🌐 集成5种翻译引擎：OpenAI、DeepL、百度翻译、谷歌翻译、本地字典
- 🔄 自动翻译器选择和故障转移
- ⚡ 异步并发翻译，速度更快
- 📊 详细的翻译状态报告
- 🎯 智能翻译策略和优先级

### 2. translation_manager.py (完整版本)
功能强大的翻译管理工具，支持：
- 自动扫描项目中的 tr() 翻译函数
...
# 使用提供的免费DeepL服务，无需配置
# 或自定义服务地址
export DEEPL_API_URL="https://deepl.borber.top"
```
